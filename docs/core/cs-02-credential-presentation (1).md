...
* Client Identifier Schemes: Usage of `x509_san_dns` or `verifier_attestation`; `decentralized_identifier` is also recommended for DID-based verifier identifiers, using DID methods such as `did:web` or `did:jwk`
