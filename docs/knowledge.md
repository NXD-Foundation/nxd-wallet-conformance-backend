...
| Pre-authorized-code grant | offer routes above and `handlePreAuthorizedCodeFlow` in `sharedIssuanceFlows.js` | `tests/preAuthSDjwRoutes.test.js`, `tests/sharedIssuanceFlows.test.js` |
