...
| KA includes `key_storage_status` | Present | CS-01 KA references a published Token Status List at `key_storage_status.status.status_list`; the issuer fetches and evaluates the bit on WUA-required issuance |
